...
import { FIRSTSEMESTER, SECONDSEMESTER } from '../Courses/Courses';

const FirstYear = ({ item, close }) => {
    const [activeSectionTop, setActiveSectionTop] = useState(null);
    const [activeSectionBottom, setActiveSectionBottom] = useState(null);
    const [coursesTop, setCoursesTop] = useState(FIRSTSEMESTER); 
    const [coursesBottom, setCoursesBottom] = useState(SECONDSEMESTER);
    ...
    return (
        <AnimatedLayout>
            ...
            <Text style={styles.accordionTitle}>First Semester Courses</Text>
            <Accordion
                sections={FIRSTSEMESTER}
            ...
            />
            <Text style={styles.accordionTitle}>Second Semester Courses</Text>
            <Accordion
                sections={SECONDSEMESTER}
